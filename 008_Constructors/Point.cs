...
// Конструктор может вызывать в том же самом объекте другой конструктор с помощю ключевого слова this.
...
namespace Classes
{
    internal class Point
    {
        ...
        // Использование ключевого слова this в конструкторе приводит к вызову контруктора с двумя параметрами с 35-й строки.
